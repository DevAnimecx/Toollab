...
const SlimSnowHeader = () => {
  return (
    <div className="slim-snow-header">
      ...
      <div className="relative z-10 flex h-full items-center justify-center text-center text-sm text-white/80 px-4">
        ...
        <a href="#" className="mx-1 font-semibold text-white hover:text-primary transition-colors hover:text-glow">Animecx</a>
        <span className="mx-2 text-white/50 hidden sm:inline">—</span>
