...
export const tools: Tool[] = [
  { name: 'Text Case Converter', description: 'Convert text to uppercase, lowercase, title case, or sentence case.', category: 'Text Utilities', tags: ['text', 'formatting', 'utility'], icon: CaseSensitive, path: '/tools/text-case-converter', component: TextCaseConverterPage, ...textAccent },
  ...
  { name: 'Image to Base64', description: 'Convert an uploaded image to a Base64 string.', category: 'File Tools', tags: ['image', 'coding', 'conversion'], icon: Image, path: '/tools/image-to-base64', component: ImageToBase64Page, ...fileAccent },
  ...
  { name: 'JSON Formatter', description: 'Format and validate JSON with syntax highlighting.', category: 'Coding Tools', tags: ['json', 'coding', 'dev'], icon: Braces, path: '/tools/json-formatter', component: JsonFormatterPage, ...codingAccent },
  ...
  { name: 'QR Code Generator', description: 'Generate a QR code from text or a URL.', category: 'Everyday Tools', tags: ['qr', 'sharing', 'generation'], icon: QrCode, path: '/tools/qr-code-generator', component: QrCodeGeneratorPage, ...everydayAccent },
  ...
  { name: 'Secure Password Generator', description: 'Generate strong, secure passwords with customizable rules.', category: 'Security Tools', tags: ['password', 'security', 'privacy'], icon: Lock, path: '/tools/password-generator', component: PasswordGeneratorPage, ...securityAccent },
  { name: 'Base64 Encoder/Decoder', description: 'Encode and decode Base64 strings instantly.', category: 'Security Tools', tags: ['encoding', 'decoding', 'data'], icon: Fingerprint, path: '/tools/base64-encoder-decoder', component: Base64EncoderPage, ...securityAccent },
  ...
  { name: 'PDF to Images Converter', description: 'Convert each page of a PDF into PNG or JPEG images.', category: 'File Tools', tags: ['pdf', 'image', 'conversion', 'export'], icon: FileImage, path: '/tools/pdf-to-images', component: PdfToImagesPage, ...fileAccent },
  ...
  { name: 'Image Color Picker', description: 'Upload an image and pick any color to get its code.', category: 'Everyday Tools', tags: ['image', 'color', 'utility', 'picker'], icon: Pipette, path: '/tools/image-color-picker', component: ImageColorPickerPage, ...everydayAccent },
  ...
  { name: 'Advanced Word Counter', description: 'Get detailed statistics about your text, live.', category: 'Text Utilities', tags: ['text', 'writing', 'stats', 'counter'], icon: Calculator, path: '/tools/advanced-word-counter', component: AdvancedWordCounterPage, ...textAccent },
  { name: 'Regex Tester', description: 'Build and test Regular Expressions in real-time.', category: 'Coding Tools', tags: ['regex', 'coding', 'search', 'dev'], icon: Regex, path: '/tools/regex-tester', component: RegexTesterPage, ...codingAccent },
  ...
  { name: 'EXIF Metadata Remover', description: 'Remove EXIF metadata from images to protect your privacy.', category: 'Security Tools', tags: ['image', 'privacy', 'security', 'exif'], icon: FileX2, path: '/tools/exif-remover', component: ExifRemoverPage, ...securityAccent },
];