...
export const tools: Tool[] = [
  ...
  { name: 'XML Formatter & Validator', description: 'Format, beautify, and validate XML code.', category: 'Coding', tags: ['xml', 'coding', 'dev', 'formatter'], icon: FileCode2, path: '/tools/xml-formatter', component: XmlFormatterPage },
