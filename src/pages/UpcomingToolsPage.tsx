...
import { Flame, Star, Lightbulb, Search, Settings } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.header 
          className="relative text-center py-20 md:py-28 rounded-3xl overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            Stay ahead of the curve — see what’s next for Toollab.
          </motion.p>
        </motion.header>
